...
def add_panoptic_lmffnet_config(cfg):
    ...
    # Panoptic-LMFFNet depth head.
    cfg.MODEL.DEPTH_HEAD = CN()
    cfg.MODEL.DEPTH_HEAD.NAME = "PanopticLMFFNetDepthEmbedHead"
    cfg.MODEL.DEPTH_HEAD.IN_FEATURES = ["FFM-B1", "FFM-B2"]
    ...
    #fg.MODEL.DEPTH_HEAD.CONVS_DIM = 256
