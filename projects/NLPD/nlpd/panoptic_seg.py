...
from .depth_seg import build_depth_embed_branch,PanopticLMFFNetDepthEmbedHead
...
class PanopticLMFFNet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.depth_embed_head = build_depth_embed_branch(cfg, self.backbone.output_shape())
    ...
    def forward(self, batched_inputs):
        ...
        depth_results, depth_losses = self.depth_embed_head(features, targets, weights)
        ...
        for sem_seg_result, center_result, offset_result, depth_result, input_per_image, image_size in zip(
            ...
            # For depth segmentation evaluation.
